...
import edu.utexas.tacc.wcs.filemanager.client.transfer.SearchResult;
import edu.utexas.tacc.wcs.filemanager.client.transfer.UrlSearch;
...
public class PnlSearch extends JPanel {
	...
	public PnlSearch(PnlBrowse pnlBrowse) {
		this();

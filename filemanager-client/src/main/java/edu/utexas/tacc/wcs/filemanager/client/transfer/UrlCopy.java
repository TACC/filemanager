...
import edu.utexas.tacc.wcs.filemanager.client.exception.UrlCopyException;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.BBFtpInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.BBFtpOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.FTPInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.FTPOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.GridFTPInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.GridFTPOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.HTTPInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.HTTPOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.IRODSInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.IRODSOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.S3InputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.S3OutputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.SFTPInputStream;
import edu.utexas.tacc.wcs.filemanager.client.transfer.streams.SFTPOutputStream;
import edu.utexas.tacc.wcs.filemanager.client.ui.ListModel;
...
//    			   }
    	   ...
    	   if (_exception != null) {
    	       edu.utexas.tacc.wcs.filemanager.client.AppMain.Error(parent,"Can't open destination file: " + _exception.getMessage());
           ...
           if(rs){
               e.printStackTrace();
               edu.utexas.tacc.wcs.filemanager.client.util.LogManager.debug(e.getLocalizedMessage() + " at " + (e.getStackTrace())[0]);  

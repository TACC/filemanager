...
import edu.utexas.tacc.wcs.filemanager.client.transfer.SHGridFTP;
import edu.utexas.tacc.wcs.filemanager.client.transfer.SearchListener;
import edu.utexas.tacc.wcs.filemanager.client.transfer.TextAppender;
...
//                cmdAdd("Cwd",oldCwd,null,true);
            ...
            AppMain.Error(this.pnlBrowse,ex.getMessage(),SGGCResourceBundle.getResourceString(ResourceName.KEY_DISPLAY_ERROR));
            ex.printStackTrace();
            edu.utexas.tacc.wcs.filemanager.client.util.LogManager.debug(ex.getLocalizedMessage() + " at " + (ex.getStackTrace())[0]);  
        }

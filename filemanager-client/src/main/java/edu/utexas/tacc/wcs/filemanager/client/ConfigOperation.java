...
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.BUNDLED_JAR_HELP;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.FILE_NAME_COG_PROPERTIES;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.FILE_NAME_LOGGING;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.FILE_NAME_USER_PROXY;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.RESOURCE_NAME_LOCAL;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.SERVICE_MYPROXY_PORT;
import static edu.utexas.tacc.wcs.filemanager.client.ConfigSettings.SERVICE_MYPROXY_SERVER;
...
import edu.utexas.tacc.wcs.filemanager.client.exception.ResourceException;
import edu.utexas.tacc.wcs.filemanager.client.transfer.FTPSettings;
import edu.utexas.tacc.wcs.filemanager.client.transfer.GridFTP;
import edu.utexas.tacc.wcs.filemanager.client.ui.Bookmark;
import edu.utexas.tacc.wcs.filemanager.client.util.Encryption;
import edu.utexas.tacc.wcs.filemanager.client.util.FileUtils;
...
import edu.utexas.tacc.wcs.filemanager.client.util.SiteUtil;
	...
	private void setup() {
		...
		try {
			...
			URL jarname = Class.forName(
					"edu.utexas.tacc.wcs.filemanager.client.ConfigOperation")

...
public class ListBucketResponse extends Response {
    ...
    static class ListBucketHandler extends DefaultHandler {
        ...
        public ListBucketHandler() {
            super();
            keyEntries = new ArrayList<ListEntry>();
        ...
        @Override
		public void startElement(String uri, String elName, String qName,
				Attributes attrs) {
            if (elName.equals("Contents")) {
                this.keyEntry = new ListEntry();
            } else if (elName.equals("Owner")) {
                this.keyEntry.owner = new Owner();
            } else if (elName.equals("CommonPrefixes")){

...
public class GsiSSH {
    ...
    public Vector<FileInfo> find(String regex) throws IOException, ServerException,
        ClientException {
        return find(".", regex, true);
    }
    
    public Vector<FileInfo> find(String rootDir, String regex) throws IOException, ServerException,
        ClientException {
        return find(rootDir, regex, true);
    }
    
    public Vector<FileInfo> find(String rootDir, String regex, boolean bShowHidden) throws IOException, ServerException,
        ClientException {

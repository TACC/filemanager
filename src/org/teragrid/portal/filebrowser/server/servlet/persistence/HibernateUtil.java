...
public class HibernateUtil {
	...
	static {
		try {
            ...
            System.out.println("current directory is: " + System.getProperty("user.home"));
			
//			System.out.println("Finding local file");
//			File file = new File("test");
//			file.createNewFile();
//			
//			System.out.println("Contents of app home are: " + file.getParentFile().list());
			
			sessionFactory = configuration.configure(
					//System.getProperty("user.home")+
			        Thread.currentThread().getContextClassLoader().getResource("hibernate.cfg.xml")).buildSessionFactory();

...
public class TeraGridSystem implements Comparable{
    ...
    public int compareTo(Object o) {
        if (o instanceof TeraGridSystem) {
            TeraGridSystem resource = (TeraGridSystem)o;
//            LogManager.debug("Comparing " + resourceName + " to " + resource.resourceName);
            return resourceName.compareTo(resource.resourceName);
        }
